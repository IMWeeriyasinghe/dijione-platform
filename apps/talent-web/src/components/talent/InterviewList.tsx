...
import type { ClientInterviewOut, InterviewOut } from "@dijione/contracts";
import { formatDateTime, stageLabel } from "@dijione/design-system";
...
import { INTERVIEW_STATUSES } from "@dijione/contracts";
