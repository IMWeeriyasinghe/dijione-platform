"""AuditLog is platform-owned — birthday-api records audit events through
Platform Core's internal API instead of writing to a local table. Mirrors
talent-api's ``AuditService`` near-verbatim.
