...
// lives inside this app, so its `declare module "vitest"` correctly merges
// against this app's own nested node_modules/vitest, unlike the same
// augmentation shipped inside the hoisted jest-dom package. Same pattern as
// apps/talent-web.
import "vitest";
